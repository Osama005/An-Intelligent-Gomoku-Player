...
class GomokuGUI:
  ...
  def minimax(self, board, depth, maximizingPlayer, heuristic):
      ...
      if maximizingPlayer:
          ...
          for move in self.get_possible_moves(board):
              ...
              eval, _ = self.minimax(new_board, depth - 1, False, heuristic)
              if eval > maxEval:
                  maxEval = eval
                  best_move = move
          ...
          for move in self.get_possible_moves(board):
              ...
              eval, _ = self.minimax(new_board, depth - 1, True, heuristic)
              if eval < minEval:
                  minEval = eval
                  best_move = move
  ...
  def ai_move(self):
      ...
      heuristic = self.simple_heuristic  # Change to self.simple_heuristic if preferred

      # Run minimax to get the best move
      _, move = self.minimax(self.board, depth=self.difficulty_depth(), maximizingPlayer=True, heuristic=heuristic)
